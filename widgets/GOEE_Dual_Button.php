...
class GOEE_Dual_Button extends Widget_Base {
    ...
    protected function render() {
        ...
        $secondary_btn_icon_pos = $settings['goee_dual_button_secondary_button_icon_position'];
        $primary_btn_icon_pos   = $settings['goee_dual_button_primary_button_icon_position'];
        ...
        $this->add_render_attribute( 
            ...
            [
                'class' => [ 
                    'goee-dual-button', 
                    esc_attr( $settings['goee_dual_button_container_alignment'] ) 
                ]
            ]
        );
        ...
        $this->add_render_attribute( 
            ...
            [
                'class' => [ 
                    'goee-dual-button-primary goee-dual-button-action', 
                    esc_attr( $settings['goee_dual_button_primary_button_animation'] ) 
                ]
            ]
        );
        ...
        $this->add_render_attribute( 
            ...
            [
                'class' => [ 
                    'goee-dual-button-secondary goee-dual-button-action', 
                    esc_attr( $settings['goee_dual_button_secondary_button_animation'] ) 
                ]
            ]
        );

        if( $settings['goee_dual_button_primary_button_url']['url'] ) {
            $this->add_render_attribute( 'goee_dual_button_primary_button_url', 'href', esc_url( $settings['goee_dual_button_primary_button_url']['url'] ) );
            if( $settings['goee_dual_button_primary_button_url']['is_external'] ) {
                $this->add_render_attribute( 'goee_dual_button_primary_button_url', 'target', '_blank' );
            }
            if( $settings['goee_dual_button_primary_button_url']['nofollow'] ) {
                $this->add_render_attribute( 'goee_dual_button_primary_button_url', 'rel', 'nofollow' );
            }
        }

        if( $settings['goee_dual_button_secondary_button_url']['url'] ) {
            $this->add_render_attribute( 'goee_dual_button_secondary_button_url', 'href', esc_url( $settings['goee_dual_button_secondary_button_url']['url'] ) );
            if( $settings['goee_dual_button_secondary_button_url']['is_external'] ) {
                $this->add_render_attribute( 'goee_dual_button_secondary_button_url', 'target', '_blank' );
            }
            if( $settings['goee_dual_button_secondary_button_url']['nofollow'] ) {
                $this->add_render_attribute( 'goee_dual_button_secondary_button_url', 'rel', 'nofollow' );
            }
        }

        $this->add_inline_editing_attributes( 'goee_dual_button_primary_button_text', 'none' );
        $this->add_inline_editing_attributes( 'goee_dual_button_connector_text', 'none' );
        $this->add_inline_editing_attributes( 'goee_dual_button_secondary_button_text', 'none' );
        ?>

        <div <?php echo $this->get_render_attribute_string( 'goee_dual_button' ); ?>>
            <div class="goee-dual-button-wrapper">
                <a <?php echo $this->get_render_attribute_string( 'goee_dual_button_primary_button_url' ); ?>>
                    <span class="<?php echo esc_attr( $primary_btn_icon_pos ); ?>">
                    <?php 
                        if ( 'goee-icon-pos-left' === $primary_btn_icon_pos && !empty( $settings['goee_dual_button_primary_button_icon']['value'] ) ) {
                            Icons_Manager::render_icon( $settings['goee_dual_button_primary_button_icon'] );
                        }
                    ?>
                        <span <?php echo $this->get_render_attribute_string( 'goee_dual_button_primary_button_text' ); ?>>
                            <?php echo esc_html( $settings['goee_dual_button_primary_button_text'] ); ?>
                        </span>
                        <?php 
                        if ( 'goee-icon-pos-right' === $primary_btn_icon_pos && !empty( $settings['goee_dual_button_primary_button_icon']['value'] ) ) {
                            Icons_Manager::render_icon( $settings['goee_dual_button_primary_button_icon'] );
                        }
                        ?>
                    </span>
                    ...
                    <?php    
                    if ( 'yes' === $settings['goee_dual_button_connector_switch'] ) { ?>
                        <div class="goee-dual-button-connector">
                        <?php if ( 'text' === $settings['goee_dual_button_connector_type'] ) { ?>
                            <span <?php echo $this->get_render_attribute_string( 'goee_dual_button_connector_text' ); ?>>
                                <?php echo esc_html( $settings['goee_dual_button_connector_text'] ); ?>
                            </span>
                            <?php 
                            }
                            if ( 'icon' === $settings['goee_dual_button_connector_type'] && !empty( $settings['goee_dual_button_connector_icon']['value'] ) ) { ?>
                                <span>
                                    <?php Icons_Manager::render_icon( $settings['goee_dual_button_connector_icon'] ); ?>
                                </span>
                            <?php } ?>
                        </div>
                    <?php } ?>
                ...
                <a <?php echo $this->get_render_attribute_string( 'goee_dual_button_secondary_button_url' ); ?>>
                    <span class="<?php echo esc_attr( $secondary_btn_icon_pos ); ?>">
                    <?php 
                        if ( 'goee-icon-pos-left' === $secondary_btn_icon_pos && !empty( $settings['goee_dual_button_secondary_button_icon']['value'] ) ) {
                            Icons_Manager::render_icon( $settings['goee_dual_button_secondary_button_icon'] );
                        }
                        ?>
                        <span <?php echo $this->get_render_attribute_string( 'goee_dual_button_secondary_button_text' ); ?>>
                            <?php echo esc_html( $settings['goee_dual_button_secondary_button_text'] ); ?>
                        </span>
                        <?php 
                        if ( 'goee-icon-pos-right' === $secondary_btn_icon_pos && !empty( $settings['goee_dual_button_secondary_button_icon']['value'] ) ) {
                            Icons_Manager::render_icon( $settings['goee_dual_button_secondary_button_icon'] );
                        }
                        ?>
                    </span>
    ...
    protected function content_template() {
        ?>
        <#
            view.addRenderAttribute( 'goee_dual_button', {
                'class': [ 
                    'goee-dual-button', 
                    settings.goee_dual_button_container_alignment
                ]
            } );

            view.addRenderAttribute( 'goee_dual_button_primary_button_url', {
                'class': [ 
                    'goee-dual-button-primary goee-dual-button-action', 
                    settings.goee_dual_button_primary_button_animation
                ]
            } );
            
            view.addRenderAttribute( 'goee_dual_button_secondary_button_url', {
                'class': [ 
                    'goee-dual-button-secondary goee-dual-button-action', 
                    settings.goee_dual_button_secondary_button_animation
                ]
            } );

            view.addInlineEditingAttributes( 'goee_dual_button_primary_button_text', 'none' );
            view.addInlineEditingAttributes( 'goee_dual_button_connector_text', 'none' );
            view.addInlineEditingAttributes( 'goee_dual_button_secondary_button_text', 'none' );

            var primaryIcon   = elementor.helpers.renderIcon( view, settings.goee_dual_button_primary_button_icon, { 'aria-hidden': true }, 'i' , 'object' );
            var connectorIcon = elementor.helpers.renderIcon( view, settings.goee_dual_button_connector_icon, { 'aria-hidden': true }, 'i' , 'object' );
            var secondaryIcon = elementor.helpers.renderIcon( view, settings.goee_dual_button_secondary_button_icon, { 'aria-hidden': true }, 'i' , 'object' );

            var primaryBtnTarget = settings.goee_dual_button_primary_button_url.lis_external ? ' target="_blank"' : '';
            var primaryBtnNofollow = settings.goee_dual_button_primary_button_url.lnofollow ? ' rel="nofollow"' : '';

            var secondaryBtnTarget = settings.goee_dual_button_secondary_button_url.is_external ? ' target="_blank"' : '';
            var secondaryBtnNofollow = settings.goee_dual_button_secondary_button_url.nofollow ? ' rel="nofollow"' : '';

        #>
            <div {{{ view.getRenderAttributeString( 'goee_dual_button' ) }}}>
                <div class="goee-dual-button-wrapper">
                    <a href="{{{ settings.goee_dual_button_primary_button_url.url }}}" {{{ view.getRenderAttributeString( 'goee_dual_button_primary_button_url' ) }}}{{{ primaryBtnTarget }}}{{{ primaryBtnNofollow }}}>
                        <span class="{{{ settings.goee_dual_button_primary_button_icon_position }}}">
                            <# if ( 'goee-icon-pos-left' === settings.goee_dual_button_primary_button_icon_position && primaryIcon.value ) { #>
                                {{{ primaryIcon.value }}}
                            <# } #>

                            <span {{{ view.getRenderAttributeString( 'goee_dual_button_primary_button_text' ) }}}>
                                {{{ settings.goee_dual_button_primary_button_text }}}
                            </span>

                            <# if ( 'goee-icon-pos-right' === settings.goee_dual_button_primary_button_icon_position && primaryIcon.value ) { #>
                                {{{ primaryIcon.value }}}
                            <# } #>
                        </span>
                        ...
                        <# if ( 'yes' === settings.goee_dual_button_connector_switch ) { #>
                            <div class="goee-dual-button-connector">
                                <# if ( 'text' === settings.goee_dual_button_connector_type ) { #>
                                    <span {{{ view.getRenderAttributeString( 'goee_dual_button_connector_text' ) }}}>
                                        {{{ settings.goee_dual_button_connector_text }}}
                                    </span>
                                <# } #>

                                <# if ( 'icon' === settings.goee_dual_button_connector_type && connectorIcon.value ) { #>
                                    <span>
                                        {{{ connectorIcon.value }}}
                                    </span>
                                <# } #>
                    ...
                    <a href="{{{ settings.goee_dual_button_secondary_button_url.url }}}" {{{ view.getRenderAttributeString( 'goee_dual_button_secondary_button_url' ) }}}{{{ secondaryBtnTarget }}}{{{ secondaryBtnNofollow }}}>
                        <span class="{{{ settings.goee_dual_button_secondary_button_icon_position }}}">
                            <# if ( 'goee-icon-pos-left' === settings.goee_dual_button_secondary_button_icon_position && secondaryIcon.value ) { #>
                                {{{ secondaryIcon.value }}}
                            <# } #>

                            <span {{{ view.getRenderAttributeString( 'goee_dual_button_secondary_button_text' ) }}}>
                                {{{ settings.goee_dual_button_secondary_button_text }}}
                            </span>

                            <# if ( 'goee-icon-pos-right' === settings.goee_dual_button_secondary_button_icon_position && secondaryIcon.value ) { #>
                                {{{ secondaryIcon.value }}}
                            <# } #>
                        </span>
                    </a>
